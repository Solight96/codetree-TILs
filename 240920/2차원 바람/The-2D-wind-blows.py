...
for _ in range(Q):
    ...
    for n in range(r1-1, r2):
        for m in range(c1-1, c2):
            if n-1 < 0:
                if m-1 < 0:
                    v[n][m] = (v2[n][m]+v2[n+1][m]+v2[n][m+1]) // 3
                elif m+1 >= M:
                    v[n][m] = (v2[n][m]+v2[n+1][m]+v2[n][m-1]) // 3
                else:
                    v[n][m] = (v2[n][m]+v2[n+1][m]+v2[n][m+1]+v2[n][m-1]) // 4
            elif n+1 >= N:
                if m-1 < 0:
                    v[n][m] = (v2[n][m]+v2[n-1][m]+v2[n][m+1]) // 3
                elif m+1 >= M:
                ...
                v[n][m] = (v2[n][m]+v2[n+1][m]+v2[n-1][m]+v2[n][m+1]) // 4
            elif m+1 >= M:
                v[n][m] = (v2[n][m]+v2[n+1][m]+v2[n-1][m]+v2[n][m-1]) // 4
            else:
                v[n][m] = (v2[n][m]+v2[n+1][m]+v2[n-1][m]+v2[n][m+1]+v2[n][m-1]) // 5
